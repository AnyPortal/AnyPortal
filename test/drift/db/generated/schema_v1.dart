...
class AssetRemote extends Table with TableInfo<AssetRemote, AssetRemoteData> {
  ...
  List<GeneratedColumn> get $columns =>
      [assetId, url, meta, autoUpdateInterval];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class AssetRemoteData extends DataClass implements Insertable<AssetRemoteData> {
  ...
  AssetRemoteData copyWith(
          {int? assetId, String? url, String? meta, int? autoUpdateInterval}) =>
      AssetRemoteData(
        assetId: assetId ?? this.assetId,
        url: url ?? this.url,
        meta: meta ?? this.meta,
  ...
  @override
  int get hashCode => Object.hash(assetId, url, meta, autoUpdateInterval);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
