      ...
      builder: (BuildContext context, Widget? child) {
        return Column(
          ...
          children: [
            keyValueRow(
              "↑",
              "${formatBytes(dataNotifier.trafficStatCur[TrafficStatType.proxyUp]!, base: 1000)}ps",
            ),
            keyValueRow(
              "↓",
              "${formatBytes(dataNotifier.trafficStatCur[TrafficStatType.proxyDn]!, base: 1000)}ps",
            ),
          ],
        );
      },
